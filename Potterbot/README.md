...
| Print | **Vase Hollow**, **Vase Bottom** (3 Archimedean-chord bottoms then spiral), and **Infill** (15% Line, 3 Archimedean-chord bottoms, 3 Archimedean-chord tops, spiral off; needs Clay Potterbot Retract). External perimeters print first. Sequential printing is **on** (one object finishes before the next). |
