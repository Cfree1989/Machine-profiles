...
| PLA temps / flow / retract | ideaMaker 230 °C / 94% / 1.5 mm at F2400 | PrusaSlicer PLA Raise3D: 215 °C first / 225 °C later, multiplier 0.94, retract 1.5 mm / 40 mm/s. Dual standby remains 180 °C. Klipper `SET_PRESSURE_ADVANCE ADVANCE=0.068` from operator T0 Ellis pattern (Garethky lines were 0.05). T1 uses the same value until measured. |
