...
- PLA ideaMaker slice (present: `[Raise3D] PLA` at 230 °C / 94% flow). PrusaSlicer PLA Raise3D matches that: 230 °C, M221 S94, multiplier 1.00, post-process 90%/106% feature FLOW.
