...
6. For PLA (`M221 … S94` plus a PrusaSlicer header), scale first-layer print E by
   90% and `;TYPE:Top solid infill` E by 106% so feature FLOW matches ideaMaker.
...
def rewrite(path: Path) -> str:
    ...
    if idx is not None and idx != 0:
        ...
        moved = True
    if moved or n_m204 or n_preheat or n_times or n_height or n_bbox or n_xy_z or n_flow:
